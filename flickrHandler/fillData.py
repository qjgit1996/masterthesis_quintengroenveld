...
filenameNoise = "/Users/quintengroenveld/swissmodel_masterthesis/road_multibuffer.tif" #path to raster
...
shapefile1 = gpd.read_file("/Users/quintengroenveld/qgis_masterthesis/validation_data_predicted.shp")

final_data = pd.DataFrame()
final_data = final_data.assign(id=shapefile1['id'])
final_data = final_data.assign(x=shapefile1['x'])
final_data = final_data.assign(y=shapefile1['y'])
final_data = final_data.assign(link=shapefile1['link'])
...
final_data.to_csv('/Users/quintengroenveld/qgis_masterthesis/validation_filled.csv', sep=";")